...
| deviceConfig.spec.remediationWorkflow.configMapImage | string | `"registry.test.pensando.io:5000/amd-gpu-operator-remediation-config-utils:latest"` | Container image used to create the remediation ConfigMap. This image contains the default remediation ConfigMap configmap.yaml file. |
